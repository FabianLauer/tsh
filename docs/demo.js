...
function main() {
	var sourceEditor = createEditor(
		...
		[
			...
			'//',
			'// Any code you enter in this window will be compiled to JavaScript',
			'// on the fly (have a look at the right hand side of the screen).',
			'//',
			'// If there\'s any errors, you\'ll find them in the "Problems" panel',
			'// at the bottom of the screen.',
			'// ',
			'',
			'class Person {',
			'	// Unlike Swift, `let` variables are mutable.',
			'	// Use `const` for immutable variables and class members.',
			'	const name',
			'',
			'	let age: Int = 0',
			'	let spouse: Person',
