...
declaration
	: declaration_specifiers ';'
		{ $$ = new yy.Node('DeclarationStatement', [$1]); }
...
struct_or_union_specifier
	: struct_or_union IDENTIFIER '{' struct_declaration_list '}'
		{ $$ = new yy.Node('StructOrUnionSpecifier', [$1, $2, $4]); }
	| struct_or_union '{' struct_declaration_list '}'
		{ $$ = new yy.Node('StructOrUnionSpecifier', [$1, $2]); }
...
struct_declaration_list
	: struct_declaration
		{ $$ = new yy.Node('StructDeclarationList', [$1]); }
	| struct_declaration_list struct_declaration
		{ $$ = new yy.Node('StructDeclarationList', [$1, $2]); }
	;

struct_declaration
	: specifier_qualifier_list struct_declarator_list ';'
		{ $$ = new yy.Node('StructDeclaration', [$1]); }
	;

specifier_qualifier_list
	: type_specifier specifier_qualifier_list
		{ $$ = new yy.Node('StructMemberDeclaration', [$1, $2]); }
	| type_specifier
		{ $$ = new yy.Node('StructMemberDeclaration', [$1, null]); }
...
struct_declarator_list
	: struct_declarator
		{ $$ = new yy.Node('StructDeclaratorList', [$1]); }
	| struct_declarator_list ',' struct_declarator
		{ $$ = new yy.Node('StructDeclaratorList', [$1, $2]); }
	;

struct_declarator
	: declarator
		{ $$ = new yy.Node('StructDeclarator', [$1]); }
	| ':' constant_expression
		{ $$ = new yy.Node('StructDeclarator', [$1, $2]); }
...
declarator
	: pointer direct_declarator
		{ $$ = new yy.Node('PointerDeclarator', [$1, $2]); }
	| direct_declarator
	;
...
direct_declarator
	...
	| direct_declarator '[' constant_expression ']'
		{ $$ = new yy.Node('ArrayIdentifier', [$1, $3]); }
	| direct_declarator '[' ']'
		{ $$ = new yy.Node('ArrayIdentifier', [$1]); }
...
pointer
	: '*'
		{ $$ = new yy.Node('PointerIdentifier', [$1]); }
	| '*' type_qualifier_list
		{ $$ = new yy.Node('PointerTypeQualifierList', [$1]); }
	| '*' pointer
		{ $$ = new yy.Node('Pointer', [$1]); }
	| '*' type_qualifier_list pointer
		{ $$ = new yy.Node('PointerTypeQualifierListPointer', [$1]); }
	;
